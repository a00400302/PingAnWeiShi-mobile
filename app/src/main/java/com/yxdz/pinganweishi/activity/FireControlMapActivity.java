...
//        setContentView(R.layout.activity_fire_control_map);
//
//        initView();
//        initMap();
//        initData();
...
/*    //订阅方法，当接收到事件的时候，会调用该方法
    ...
    public void onEvent(EventBusBean eventBusBean) {
        //华为手机推送下来
        if ("pushData".equals(eventBusBean.getFlag())) {
            PushBean pushBean = (PushBean) eventBusBean.getObject();
            placeId = pushBean.getPlaceId();
            fireDate = pushBean.getDateTime();
        }
    }*/
...
//                高德地图
                        try {
                            ...
                            Toast.makeText(FireControlMapActivity.this, "没有安装高德地图,请先安装", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//                百度地图
                        try {
                            ...
                            Toast.makeText(FireControlMapActivity.this, "没有安装百度地图,请先安装", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
...
//            Intent intent=new Intent(FireControlMapActivity.this,FireDeviceInfoActivity.class);
...
//                Intent main = new Intent(FireControlMapActivity.this, MainActivity.class);
