...
public class DoorLockBindlistAdapter extends RecyclerView.Adapter<DoorLockBindlistAdapter.ViewHolder> {

    List<ViewHolder> viewHolders = new ArrayList<>();
    private final Context context;
    private final List<DoorLockBindBean.DeviceBindListBean> bindDeviceBeans;


    public DoorLockBindlistAdapter(Context context, List<DoorLockBindBean.DeviceBindListBean> bindDeviceBeans) {
    ...
    public void submit() {
        onItemClickListener.onOkLockClick(bindDeviceBeans);
    }
