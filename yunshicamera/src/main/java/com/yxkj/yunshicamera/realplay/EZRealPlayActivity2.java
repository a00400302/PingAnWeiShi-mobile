...
import com.yxkj.yunshicamera.R;
import com.yxkj.yunshicamera.realplay.common.ScreenOrientationHelper;
import com.yxkj.yunshicamera.realplay.demo.DemoConfig;
import com.yxkj.yunshicamera.realplay.util.ActivityUtils;
import com.yxkj.yunshicamera.realplay.util.AudioPlayUtil;
import com.yxkj.yunshicamera.realplay.util.DataManager;
import com.yxkj.yunshicamera.realplay.util.EZUtils;
import com.yxkj.yunshicamera.realplay.util.VideoFileUtil;
import com.yxkj.yunshicamera.realplay.view.LoadingTextView;
import com.yxkj.yunshicamera.realplay.view.VerifyCodeInput;
import com.yxkj.yunshicamera.realplay.view.WaitDialog;
...
public class EZRealPlayActivity2 extends RootActivity implements OnClickListener, SurfaceHolder.Callback,
        Handler.Callback, OnTouchListener , VerifyCodeInput.VerifyCodeInputListener {
    private static final String TAG = EZRealPlayActivity2.class.getSimpleName();
...
//        client = new GoogleApiClient.Builder(this).addApi(AppIndex.API).build();
    ...
    private void initInfo() {
        ...
        mCameraInfo.setDeviceSerial("D27333953");
        mCameraInfo.setCameraName("C6C(D27333953)");


        mDeviceInfo = new EZDeviceInfo();
        mDeviceInfo.setDeviceName("C6C(D27333953)");
...
//        }
    ...
    private void updateOrientation() {
        if (mIsOnTalk) {
            if (mEZPlayer != null && mDeviceInfo != null && mDeviceInfo.isSupportTalk() != EZTalkbackCapability.EZTalkbackNoSupport) {
            ...
            if (mRealPlayFullTalkAnimBtn != null) {
                ...
                mRealPlayFullOperateBar.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mEndXy[0] = Utils.dip2px(EZRealPlayActivity2.this, 20);
                        mEndXy[1] = mStartXy[1];
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.realplay_play_btn || i == R.id.realplay_full_play_btn || i == R.id.realplay_play_iv) {
            if (mStatus != RealPlayStatus.STATUS_STOP) {
                stopRealPlay();
                setRealPlayStopUI();
            } else {
        ...
        } else if (i == R.id.realplay_previously_btn || i == R.id.realplay_previously_btn2 || i == R.id.realplay_full_previously_btn) {
            onCapturePicBtnClick();
        } else if (i == R.id.realplay_capture_rl) {
            onCaptureRlClick();
        } else if (i == R.id.realplay_video_btn || i == R.id.realplay_video_start_btn || i == R.id.realplay_video_btn2 || i == R.id.realplay_video_start_btn2 || i == R.id.realplay_full_video_btn || i == R.id.realplay_full_video_start_btn) {
            onRecordBtnClick();
        } else if (i == R.id.realplay_talk_btn || i == R.id.realplay_talk_btn2 || i == R.id.realplay_full_talk_btn) {
            startVoiceTalk();
        } else if (i == R.id.realplay_quality_btn) {
//            openQualityPopupWindow(mRealPlayQualityBtn);
        } else if (i == R.id.realplay_ptz_btn || i == R.id.realplay_ptz_btn2) {
            openPtzPopupWindow(mRealPlayPlayRl);
        } else if (i == R.id.realplay_full_ptz_btn) {
            setFullPtzStartUI(true);
        } else if (i == R.id.realplay_full_ptz_anim_btn) {
            setFullPtzStopUI(true);
        } else if (i == R.id.realplay_sound_btn || i == R.id.realplay_full_sound_btn) {
            onSoundBtnClick();
        } else if (i == R.id.realplay_full_talk_anim_btn) {
    ...
    private void startVoiceTalk() {
        ...
        if (mOrientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            startFullBtnAnim(mRealPlayFullAnimBtn, mStartXy, mEndXy, new AnimationListener() {
                ...
                @Override
                public void onAnimationEnd(Animation animation) {
                    Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_full_talk_start_tip);
                    mRealPlayFullTalkAnimBtn.setVisibility(View.VISIBLE);
                    mRealPlayFullAnimBtn.setVisibility(View.GONE);
                    onRealPlaySvClick();
                    //                    mFullscreenFullButton.setVisibility(View.VISIBLE);
    ...
    private OnClickListener mOnPopWndClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            int i = v.getId();
            if (i == R.id.quality_super_hd_btn) {
                setQualityMode(EZVideoLevel.VIDEO_LEVEL_SUPERCLEAR);
            } else if (i == R.id.quality_hd_btn) {
            ...
            } else if (i == R.id.ptz_close_btn) {
                closePtzPopupWindow();
            } else if (i == R.id.ptz_flip_btn) {//                    setPtzFlip();
            } else if (i == R.id.talkback_close_btn) {
                closeTalkPopupWindow(true, false);
            }
        }
    };
    ...
    private void setQualityMode(final EZVideoLevel mode) {
        ...
        if (!ConnectionDetector.isNetworkAvailable(EZRealPlayActivity2.this)) {
            // 提示没有连接网络 Prompt not to connect to the network
            Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_set_fail_network);
            return;
        }
            ...
            public void run() {
                if (mTalkRingView != null) {
                    mTalkRingView.setMinRadiusAndDistance(mTalkBackControlBtn.getHeight() / 2f,
                            Utils.dip2px(EZRealPlayActivity2.this, 22));
                }
            }
        });
    }
    ...
    private void onRecordBtnClick() {
        ...
        if (!SDCardUtil.isSDCardUseable()) {
            ...
            Utils.showToast(EZRealPlayActivity2.this, R.string.remoteplayback_SDCard_disable_use);
            return;
        }
        ...
        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
            ...
            Utils.showToast(EZRealPlayActivity2.this, R.string.remoteplayback_record_fail_for_memory);
            return;
        }
    ...
    private void onCapturePicBtnClick() {
        ...
        if (SDCardUtil.getSDCardRemainSize() < SDCardUtil.PIC_MIN_MEM_SPACE) {
            // 提示内存不足
            //Prompt for insufficient memory
            Utils.showToast(EZRealPlayActivity2.this, R.string.remoteplayback_capture_fail_for_memory);
            return;
        }
                ...
                public void run() {
                    ...
                    if (bmp != null) {
                        try {
                            ...
                            MediaScanner mMediaScanner = new MediaScanner(EZRealPlayActivity2.this);
                            mMediaScanner.scanFile(strCaptureFile, "jpg");
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(EZRealPlayActivity2.this, getResources().getString(R.string.already_saved_to_volume) + strCaptureFile, Toast.LENGTH_SHORT).show();
                                }
                            });
    ...
    private void handlePtzControlFail(Message msg) {
        ...
        switch (msg.arg1) {
            case ErrorCode.ERROR_CAS_PTZ_CONTROL_CALLING_PRESET_FAILED:
                ...
                Utils.showToast(EZRealPlayActivity2.this, R.string.camera_lens_too_busy, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_PRESETING_FAILE:// 当前正在调用预置点
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_is_preseting, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_CONTROL_TIMEOUT_CRUISE_TRACK_FAILED:
                ...
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_control_timeout_cruise_track_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_INVALID_POSITION_FAILED:
                // 当前预置点信息无效
                //The current preset information is invalid
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_preset_invalid_position_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_CURRENT_POSITION_FAILED:
                // 该预置点已是当前位置
                //The preset point is the current position
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_preset_current_position_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_SOUND_LOCALIZATION_FAILED:
                // 设备正在响应本次声源定位
                //The device is responding to this sound source location
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_preset_sound_localization_failed, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_MIRRORING_FAILED:// 设备正在镜像操作（设备镜像要几秒钟，防止频繁镜像操作）The device is mirroring (the device mirroring takes a few seconds to prevent frequent mirroring)
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_operation_too_frequently, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_PRESET_EXCEED_MAXNUM_FAILED:// 当前预置点超过最大个数 The current preset exceeds the maximum number
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_preset_exceed_maxnum_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRIVACYING_FAILED:// 设备处于隐私遮蔽状态（关闭了镜头，再去操作云台相关）The device is in a privacy state (close the lens, and then operate the PTZ related)
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_privacying_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_TTSING_FAILED:// 设备处于语音对讲状态(区别以前的语音对讲错误码，云台单独列一个）Equipment in the voice intercom state (the difference between the previous voice intercom error code, PTZ separate one)
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_mirroring_failed, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_ROTATION_RIGHT_LIMIT_FAILED:// 设备云台旋转到达右限位 The PTZ rotation reaches the right limit
                ...
                break;
            default:
                Utils.showToast(EZRealPlayActivity2.this, R.string.ptz_operation_failed, msg.arg1);
                break;
        }
    }
...
/*
    ...
    private void handleVoiceTalkFailed(ErrorInfo errorInfo) {
        ...
        switch (errorInfo.errorCode) {
            case ErrorCode.ERROR_TRANSF_DEVICE_TALKING:
                Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_play_talkback_fail_ison);
                break;
            case ErrorCode.ERROR_TRANSF_DEVICE_PRIVACYON:
                Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_play_talkback_fail_privacy);
                break;
            case ErrorCode.ERROR_TRANSF_DEVICE_OFFLINE:
                Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_fail_device_not_exist);
                break;
            ...
            case ErrorCode.ERROR_TTS_HNADLE_TIMEOUT:
                Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_play_talkback_request_timeout, errorInfo.errorCode);
                break;
            ...
            case ErrorCode.ERROR_CAS_AUDIO_SEND_ERROR:
                Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_play_talkback_network_exception, errorInfo.errorCode);
                break;
            default:
                Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_play_talkback_fail, errorInfo.errorCode);
                break;
        }
    }
    ...
    private void handleSetVedioModeFail(int errorCode) {
        ...
        Utils.showToast(EZRealPlayActivity2.this, R.string.realplay_set_vediomode_fail, errorCode);
    }
    ...
    private void handleRecordFail() {
        Utils.showToast(EZRealPlayActivity2.this, R.string.remoteplayback_record_fail);
        if (isRecording) {
            stopRealPlayRecord();
        }
    }
    ...
    private void handlePlaySuccess(Message msg) {
        ...
        //        startPrivacyAnim();
        updateTalkUI();
        if (mDeviceInfo != null && mDeviceInfo.isSupportTalk() != EZTalkbackCapability.EZTalkbackNoSupport) {
            mRealPlayTalkBtn.setEnabled(true);
        } else {
            mRealPlayTalkBtn.setEnabled(false);
        }
    ...
    private void updateRealPlayFailUI(int errorCode) {
        ...
        switch (errorCode) {
            case ErrorCode.ERROR_TRANSF_ACCESSTOKEN_ERROR:
                ActivityUtils.goToLoginAgain(EZRealPlayActivity2.this);
                return;
...
//        int i = v.getId();
//        if (i == R.id.realplay_pages_gallery) {
//            mRealPlayTouchListener.touch(event);
//        } else if (i == R.id.realplay_full_operate_bar) {
//            return true;
//        }
        return false;
    }
    ...
    private void showType() {
        if (Config.LOGGING && mEZPlayer != null) {
            Utils.showLog(EZRealPlayActivity2.this, "getType " + ",time：" + (mStopTime - mStartTime));
        }
    }
