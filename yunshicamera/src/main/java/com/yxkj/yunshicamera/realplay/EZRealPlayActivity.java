...
//        mCameraInfo.setDeviceSerial("D27333967");
//        mCameraInfo.setCameraName("C6C(D27333967)");
        mCameraInfo.setDeviceSerial(deviceSerial);
        mCameraInfo.setCameraName(cameraName);


        mDeviceInfo = new EZDeviceInfo();
//        mDeviceInfo.setDeviceName("C6C(D27333967)");
        mDeviceInfo.setDeviceName(cameraName);
